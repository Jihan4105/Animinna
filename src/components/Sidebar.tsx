...
export default function Sidebar({ status, setSidebarStatus }: {
  ...
  return (
    <div className={`fixed z-100 top-0 right-0 h-screen w-1/2 bg-white dark:bg-[#2D1F50] shadow-lg transition-transform duration-300 ${status === "open" ? "translate-x-0" : "translate-x-full"} sm:hidden`}>
